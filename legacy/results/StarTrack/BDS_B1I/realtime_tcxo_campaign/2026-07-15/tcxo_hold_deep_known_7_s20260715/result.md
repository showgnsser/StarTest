# 7 dB-Hz known-bit deep hold - seed 20260715
...
- 状态路径：`Deep`。
- 末段多普勒 RMS / P95 / 最大绝对误差：0.4326 / 0.7880 / 1.1832 Hz。
- 末段码相位 MAE / P95 / 最大绝对误差：0.0221 / 0.0600 / 0.0808 chip。
- C/N0 偏差 / RMSE / 有效率：-1.486 / 2.991 dB / 0.990。
- 回捕次数：0；切换后发散次数：0。
- 仿真墙钟耗时：220.55 s，处理速度为实时的 4.08 倍。
