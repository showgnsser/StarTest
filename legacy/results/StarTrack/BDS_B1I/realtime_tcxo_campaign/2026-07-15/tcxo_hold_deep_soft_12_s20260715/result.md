# 12 dB-Hz autonomous deep hold - seed 20260715

## 测试目的

Validate the current autonomous weak-signal retention boundary without known navigation bits.
...
- 状态路径：`Deep`。
- 末段多普勒 RMS / P95 / 最大绝对误差：1.5277 / 3.0601 / 3.4158 Hz。
- 末段码相位 MAE / P95 / 最大绝对误差：0.0800 / 0.1570 / 0.1727 chip。
- C/N0 偏差 / RMSE / 有效率：-1.212 / 1.471 dB / 1.000。
- 回捕次数：0；切换后发散次数：0。
- 仿真墙钟耗时：199.98 s，处理速度为实时的 4.50 倍。
