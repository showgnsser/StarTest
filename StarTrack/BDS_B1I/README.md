...
|---|---:|---:|---:|
| 牵引灵敏度 | 24 dB-Hz | -146 dBm | 24 dB-Hz / -146 dBm |
| 无电文辅助持续灵敏度 | 10 dB-Hz | -160 dBm | 待运行 |
...
| 场景 | 单次时长 | 当前结论 |
|---|---:|---|
| [牵引灵敏度](01_pull_in_sensitivity/README.md) | 120 s | 35/35 通过 |
...
|---|---|---|---|---|
| `503cdea` | pullin-v2 | 牵引灵敏度 | 首次固定五种子基准 | 35/35 通过 |
