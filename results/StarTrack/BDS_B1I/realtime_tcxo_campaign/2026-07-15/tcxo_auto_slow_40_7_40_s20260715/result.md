# Slow 40 to 7 to 40 dB-Hz fade - seed 20260715
...
- 末段多普勒 RMS / P95 / 最大绝对误差：0.1585 / 0.3422 / 0.5501 Hz。
- 末段码相位 MAE / P95 / 最大绝对误差：0.0047 / 0.0182 / 0.0269 chip。
- C/N0 偏差 / RMSE / 有效率：-0.834 / 0.942 dB / 1.000。
- 回捕次数：0；切换后发散次数：0。
- 仿真墙钟耗时：121.39 s，处理速度为实时的 7.41 倍。
