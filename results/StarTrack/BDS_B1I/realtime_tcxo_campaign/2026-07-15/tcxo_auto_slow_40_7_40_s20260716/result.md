# Slow 40 to 7 to 40 dB-Hz fade - seed 20260716
...
- 末段多普勒 RMS / P95 / 最大绝对误差：0.1758 / 0.3810 / 0.7515 Hz。
- 末段码相位 MAE / P95 / 最大绝对误差：0.0046 / 0.0156 / 0.0376 chip。
- C/N0 偏差 / RMSE / 有效率：-0.810 / 0.885 dB / 1.000。
- 回捕次数：0；切换后发散次数：0。
- 仿真墙钟耗时：121.41 s，处理速度为实时的 7.41 倍。
