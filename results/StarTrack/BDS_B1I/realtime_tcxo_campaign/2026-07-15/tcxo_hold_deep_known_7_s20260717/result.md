# 7 dB-Hz known-bit deep hold - seed 20260717
...
- 状态路径：`Deep`。
- 末段多普勒 RMS / P95 / 最大绝对误差：0.4955 / 1.0152 / 1.3448 Hz。
- 末段码相位 MAE / P95 / 最大绝对误差：0.0240 / 0.0837 / 0.0964 chip。
- C/N0 偏差 / RMSE / 有效率：-0.885 / 2.233 dB / 0.987。
- 回捕次数：0；切换后发散次数：0。
- 仿真墙钟耗时：123.59 s，处理速度为实时的 7.28 倍。
