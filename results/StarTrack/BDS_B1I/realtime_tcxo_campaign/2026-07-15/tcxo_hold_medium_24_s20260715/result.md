# 24 dB-Hz medium-signal hold - seed 20260715

## 测试目的

Measure the long-term stability of the medium-signal operating range.
...
- 状态路径：`Medium`。
- 末段多普勒 RMS / P95 / 最大绝对误差：0.2966 / 0.5935 / 1.3407 Hz。
- 末段码相位 MAE / P95 / 最大绝对误差：0.0116 / 0.0278 / 0.0340 chip。
- C/N0 偏差 / RMSE / 有效率：-0.707 / 0.733 dB / 1.000。
- 回捕次数：0；切换后发散次数：0。
- 仿真墙钟耗时：114.14 s，处理速度为实时的 7.89 倍。
